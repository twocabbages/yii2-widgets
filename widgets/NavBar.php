...
class NavBar extends Widget
{
    ...
    public function init()
    {
        ...
        Html::addCssClass($this->options, 'navbar-fixed-top navbar');
        $this->options['id'] = 'navbar';
        ...
        echo Html::beginTag('div', ['class' => 'navbar-header pull-left']);
        ...
        Html::addCssClass($this->containerOptions, 'navbar-header pull-right');
